...
<html>
    <head>
        <style>
            ...
            .header { background-color: #d8b593; color: white; padding: 10px; text-align: center; }
            ...
            .total { font-size: 18px; font-weight: bold; color: #d8b593; }
        ...
        <div class="email-container">
            ...
            <div class="header">
                <div style="width:100%; text-align:center;">
                    <img src="https://satya-studio.com/satya.png" 
