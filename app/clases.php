			...
			<div id="eventoModal" class="card colso">
				<div class="modal-contentCal" id="modal-content" style="position: relative;">
					...
					<div class="m2" style="padding: 20px;">
						<div class="m3">
							<p class="m4" style="color: #BFA187;font-size: 14px;font-weight: 700;display: flex;align-items: center;gap: 6px;line-height: 1;margin-bottom: 0;">
								<i class="fas fa-user-alt"></i>
								<a href="#" id="modalInstructor" style="color: #BFA187;font-size: 19px;font-weight: 700;"></a>
								<button class="cambiar-instructor-clase-btn">Cambiar Instructor</button>
							</p>
							<div style="display: flex;justify-content: space-between; border-bottom: 1px solid #c5c5c5;">
								<h4 style="display: flex;align-items: baseline;gap: 5px;font-size: 15px;line-height: 1;margin-bottom: -17px;"><i class="icon-clock" style="color: #636363"></i>
									<p id="modalDuracion" style="font-weight: 100;color: #636363;"></p>
								</h4>
