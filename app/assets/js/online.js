            ...
            response.cursos.forEach(function(curso) {
                ...
                cursosHTML += `
                    <div class="col-md-4 mb-4">
                        <div class="card card-post card-round" style="height: 420px;">
                            ...
                            <div class="card-body">
                                ...
                                <span style="font-size: 0.90rem;color: #999;margin-bottom: 15px;">${curso.duracion} min | ${curso.nivel} | ${curso.equipo}</span>
                                <div class="d-flex justify-content-between" style="margin-top: 10px;">
                                    <a href="./alta-online.php?id=${curso.id}" class="btn btn-primary btn-rounded btn-sm"><i class="far fa-edit"></i> Ver</a>
                                    <button onclick="deleteOnline(${curso.id}) "class="btn btn-danger btn-rounded btn-sm"><i class="fas fa-trash"></i> Eliminar</button>
