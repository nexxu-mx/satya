                                ...
                                <div class="card-body">
                                    <form action="save_user.php" method="post" onsubmit="trimTrailingSpaces()">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-floating form-floating-custom mb-3">
                                                    ...
                                                    <label for="pass" <?php if ((int)$_SESSION['tipoUser'] == 4) {
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-1">
                                                <div class="form-floating form-floating-custom mb-3">
                                                    <input type="text" class="form-control" id="creditos" name="creditos" value="<?php echo $credit; ?>" placeholder="name@example.com" <?php if ((int)$_SESSION['tipoUser'] == 4) {
                                                                                                                                                                                            echo "readonly";
                                                                                                                                                                                        }; ?>>
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-floating form-floating-custom mb-3">
                                                    <input type="date" class="form-control" id="vencecreditos" name="vencecreditos" value="<?php echo $credVenci; ?>" placeholder="name@example.com" <?php if ((int)$_SESSION['tipoUser'] == 4) {
                                                                                                                                                                                                        echo "readonly";
                                                                                                                                                                                                    }; ?>>
