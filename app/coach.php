...
<body>
		...
		<div class="main-panel">
			...
			<div class="container">
                ...
                <div class="page-header">
						<h3 class="fw-bold mb-3">Coaches</h3>
                    ...
                    <div id="curs">
					    	     <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
                						...
                						<div class="ms-md-auto py-2 py-md-0">
                							<a href="alta-coach.php" class="btn btn-primary btn-round"><i class="fas fa-plus"></i> Nuevo Coach</a>
                						</div>
                					</div>
	...
	<script src="./assets/js/coach.js?v=<?php echo time(); ?>"></script>
