...
$coachez = $_GET['id'];
    if(empty($coachez)){
        ...
        $sql = "SELECT nombre_coach, descripcion_coach, activo, id_disciplina FROM coaches WHERE id = ?";
        $smtp = $conn->prepare($sql);
        $smtp->bind_param("i", $coachez);
        $smtp->execute();
            ...
            <div class="container">
                <div class="page-inner">
                    ...
                    <div id="form-disc" class="container-sm w-50 form-control p-5 mt-5">
                        <form action="editar_coach.php" method="POST" class="needs-validation" enctype="multipart/form-data">
                             <div class="d-flex justify-content-center mb-3">
                                <img id="vistaPrevia" <?php 
                            ...
                            <label for="imagen" class="my-3">Actualizar imagen</label>
        ...
        function deleteCoach(id) {
            ...
            .then(data => {
                if (data.trim() === 'success') {
                    ...
                    alert('Error al eliminar el coach: ' + data);
                }
            })
            .catch(error => {
