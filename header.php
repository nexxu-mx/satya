...
<div class="container">
  ...
  <a href="https://satya-studio.com" class="logo">
    <!--logo SATYA -->
  ...
  <nav class="navbar">
      ...
      <ul class="navbar-list">
       <li class="navbar-item">
          <a href="https://satya-studio.com" class="navbar-link title-md">Inicio</a>
        </li>
        <li class="navbar-item">
        ...
        <li class="navbar-item">
          <a href="class-online.php" class="navbar-link title-md">Online</a>
        </li>
        <li class="navbar-item">
...
<div class="header-mobile active" id="header-mobile">
    <a href="index.php" class="hmobile"><ion-icon name="home" aria-hidden="true" role="img" class="md hydrated"></ion-icon></a>
    <a href="reserva.php" class="hmobile"><ion-icon name="calendar-number-outline" aria-hidden="true" role="img" class="md hydrated"></ion-icon></a>
    ...
    <button class="nav-open-btn mobile-log" aria-label="open menu" data-nav-toggler="">
        <ion-icon name="menu-outline" style="color: #2e2e2e;" role="img" class="md hydrated" aria-label="menu outline"></ion-icon>
    </button>
