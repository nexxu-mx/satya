...
<body id="top" style="background: rgb(228, 222, 206)">
    ...
    <main >
        <section class="ab0">
            <article class="container">
                ...
                <div class="ab2">
                    <div class="ab3">
                        <img src="./assets/images/aboutus.jpg" class="ab4" alt="SATYA Studio ">
                    </div>
                    <div class="ab5">
                        <h2>Nuestra Filosofía</h2>
                        <p>Conecta cuerpo y mente a
                            través del <b style="color: var(--c7); font-weight: 500">movimiento</b>
                            consciente diario.
                        </p>
                        <div class="ab6">
                            Balance - Control - Tone
                        </div>
                    </div>
                </div>
            </article>
        ...
        <section class="ab7">
            <article class="container ">
                    <div class="ab8">
                        <div class="ab9">
                            <img src="./assets/images/studio.jpg" class="ab10" alt="SATYA Studio ">
                        </div>
                        <div class="ab11">
                            <h2>The Studio</h2>
                            <p>Un espacio minimalista y acogedor, diseñado para moverte con calma, fuerza y conexión.</p>
                        </div>
                    </div>
            </article>
        </section>
