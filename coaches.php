    ...
    <main style="background: var(--background)">
        <article>
            <section class="section">
                <div class="container">
                    <div class="tittle-coaches">
                        <h3>Conoce</h3>
                        <h2>Nuestras Coaches</h2>
                        <div class="lotoreserva">
                            <img src="./assets/img/icono_loto.svg"  alt="">
                        </div>
                    </div>
                        <div class="section-coaches">
                            ...
                            while ($fila = mysqli_fetch_assoc($resultado)) {
                                ...
                                $defaultPath = "./assets/images/coaches/pro/" . $fila['id'] . "png?=" . time();
                                ...
                                echo '
                                    ...
                                    <div class="card-coach-index" id="'. $fila['nombre_coach'] .'">
                                    ' . $imgC . '
                                    <div class="descrip-coach-index">
                                    <h3>'. $disciplina .'</h3>
                                    <p>'. $fila['descripcion_coach'] .'</p>
                                    </div>
                                    <a>'. $fila['nombre_coach'] .'</a>
                                </div>
                                ';
                            }
