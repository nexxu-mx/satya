  ...
  fetch(url)
    ...
    .then(data => {
      ...
      data.forEach(clase => {
        ...
        console.log(clase.evento);
        if(clase.evento == true){
          if (clase.abierta == "1") {
            reservable = `<a class="btn-reservar" href="https://wa.me/524778996360?text=Hola,%20Quiero%20reservar%20el%20evento%20AURA%20Class.">RESERVAR</a>`;
          }
          btn.innerHTML = `
