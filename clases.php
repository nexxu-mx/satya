    ...
    <main >
      <article>
        <section class="main-section" >
          <div class="container">
            <div class="cla1">
                <span class="cla2">Conoce</span>
                <h1 class="cla3">Nuestras Disciplinas</h1>
                      ...
                      while($fila = mysqli_fetch_assoc($resultado)) {
                        ...
                        if(file_exists($pathVideo)){
                          $imgp = '<figure class="fig-class">
                                    <video class="video-class" src="' . $pathVideo . '" poster="./assets/images/disciplinas/'. $fila['id'] .'.png" loop muted playsinline webkit-playsinline></video>
                        ...
                        // 
                        echo '
                        <div class="cla5" id="nombreclase">
                            <div class="cla6">
                              <h2>'. $fila['nombre_disciplina'] .'</h2>
                              <p>
                                    '. $fila['descripcion_disciplina'] .'
                              </p>
                            </div>
                            <div class="cla7">
                               '. $imgp .'
